 ...
 */
class MemberListRecyclerViewAdapter(private val onItemClickListener: (ArcherMemberResponse) -> Unit) :
    ...
    override fun onBindItem(view: View, data: ArcherMemberResponse, position: Int) {
        view.presence_item_image_profile.loadWithGlidePlaceholder(data.public_photo ?: "")
